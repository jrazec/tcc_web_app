...
function isLightBackground() {
    ...
    // formula sa tingkad base sa rgb
    var luminance = (0.2126 * rgb[0] + 0.7152 * rgb[1] + 0.0722 * rgb[2]);
    // cheker if yung tingkad ay masmalinaw sa bg
...
function newShell() {
    ...
    var chosenColors = isLightBackground() ? ['#111', '#222', '#333', '#444', '#555'] : colors;
    shell.color = chosenColors[Math.floor(Math.random() * chosenColors.length)];
